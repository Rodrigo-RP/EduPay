...
- Name: 12-antiguedad-saldos.spec.ts >> Antigüedad de Saldos — E2E (RPT-07) >> T1: 6 tarjetas de bucket con montos $ visibles (datos reales del campus demo)
- Location: e2e/12-antiguedad-saldos.spec.ts:60:3
