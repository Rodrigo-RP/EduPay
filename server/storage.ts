  ...
  async getChargesByStudent(studentId: number): Promise<(Charge & { concept: Concept })[]> {
    return await db
      .select({
        ...
        plan_id: charges.plan_id,
        es_adeudo_migrado: charges.es_adeudo_migrado,
        descripcion: charges.descripcion,
        manual_override: charges.manual_override,
        manual_override_reason: charges.manual_override_reason,
