            ...
            <CardContent className="p-0">
              <div className="flex items-center justify-between gap-2">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-lg md:text-xl font-bold text-blue-600 whitespace-nowrap">{estadisticas.activos}</p>
            ...
            <CardContent className="p-0">
              <div className="flex items-center justify-between gap-2">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs md:text-sm font-bold text-blue-600 whitespace-nowrap">${(estadisticas.saldoPendiente / 100).toLocaleString()}</p>
            ...
            <CardContent className="p-0">
              <div className="flex items-center justify-between gap-2">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs md:text-sm font-bold text-blue-600 whitespace-nowrap">${(estadisticas.promedioSaldo / 100).toLocaleString()}</p>
