...
- `STRIPE_SECRET_KEY` actual en Replit: **clave rotada / posiblemente inválida** — el usuario rotó la clave en el Stripe Dashboard de Refereence el 2026-08-17. Actualizar el secret antes de usar cualquier endpoint de Stripe.
