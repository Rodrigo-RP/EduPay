...
export default function CuentasPorCobrar() {
  ...
  // Datos de respaldo si la API no devuelve datos
  ...
  // Función para filtrar datos
    ...
    },
    {
      ...
      observaciones_cobranza: "Pago de otros conceptos completado"
    },
    {
      id: 10,
    ...
    {
      id: 16,
      estudiante: "Santiago Ruiz Morales",
      responsable: "Ana Morales Ruiz",
      telefono: "5556677889",
      ...
      fecha_cargo: "2025-01-15",
      monto_inicial_centavos: 250000,
      descuentos_centavos: 0,
      recargos_centavos: 0,
      total_pagado_centavos: 250000,
      pendiente_pagar_centavos: 0,
      dias_vencido: 0,
      estado_cobranza: "PAGADO",
      ...
      cuenta_habilitada: true,
      fecha_ultimo_seguimiento: "2025-01-16",
      observaciones_cobranza: "Inscripción Kinder completada exitosamente"
    },
    {
      id: 17,
      estudiante: "Valentina Castro López",
      responsable: "Pedro Castro Mendoza",
      telefono: "5557788991",
      email: "pedro.castro@yahoo.com",
      nivel_escolar: "PRIMARIA",
      grado: "1ro Primaria",
      concepto: "Inscripciones",
      fecha_cargo: "2025-01-12",
      monto_inicial_centavos: 280000,
      descuentos_centavos: 28000,
      recargos_centavos: 0,
      total_pagado_centavos: 0,
      pendiente_pagar_centavos: 252000,
      dias_vencido: 0,
      estado_cobranza: "CORRIENTE",
      ...
      cuenta_habilitada: true,
      fecha_ultimo_seguimiento: "2025-01-18",
      observaciones_cobranza: "Beca 10% aplicada, pendiente pago inscripción"
    },
    {
      id: 18,
      estudiante: "Matías Vargas Sánchez",
      responsable: "Claudia Sánchez Vargas",
      telefono: "5558899001",
      email: "claudia.sanchez@hotmail.com",
      nivel_escolar: "SECUNDARIA",
      grado: "1ro Secundaria",
      concepto: "Inscripciones",
      fecha_cargo: "2025-01-08",
      monto_inicial_centavos: 320000,
      descuentos_centavos: 0,
      recargos_centavos: 0,
      ...
      cuenta_habilitada: true,
      fecha_ultimo_seguimiento: "2025-01-20",
      observaciones_cobranza: "Pago parcial recibido, pendiente saldo inscripción"
    },
    {
      id: 19,
      estudiante: "Regina Flores Jiménez",
      responsable: "Alberto Flores Castro",
      telefono: "5559900223",
      email: "alberto.flores@gmail.com",
      nivel_escolar: "BACHILLERATO",
      grado: "1ro Bachillerato",
      concepto: "Inscripciones",
      fecha_cargo: "2025-01-05",
      ...
      fecha_compromiso: null,
      cuenta_habilitada: true,
      fecha_ultimo_seguimiento: "2025-01-06",
      observaciones_cobranza: "Inscripción Bachillerato pagada completamente"
    }
  ];
